define(['app', 'angular'], function(appModule, angular) {
    ...
    describe('Kaltura directive', function() {
        ...
        it('it should append the proper script, div, and have the proper class', function() {
            ...
            expect(appendedScript.attr('src')).toMatch(/https:\/\/cdnapisec\.kaltura\.com\/p\/partner-1337\/sp\/partner-133700\/embedIframeJs\/uiconf_id\/123-456-def\/partner_id\/partner-1337\?autoembed=true&entry_id=abc123&playerId=kaltura_player_\d{10}&cache_st=\d{10}&flashvars\[streamerType\]=auto/);
        ...
        it('should watch the videoid and reload the video', function() {
            ...
            expect(script.attr('src')).toMatch(/https:\/\/cdnapisec\.kaltura\.com\/p\/partner-1337\/sp\/partner-133700\/embedIframeJs\/uiconf_id\/123-456-def\/partner_id\/partner-1337\?autoembed=true&entry_id=different&playerId=kaltura_player_\d{10}&cache_st=\d{10}&flashvars\[streamerType\]=auto/);
        });
        ...
        it('should watch the partnerid and reload the video', function() {
            ...
            expect(angular.element.prototype.append.calls.count()).toBe(2);
            var script = angular.element.prototype.append.calls.mostRecent().args[0];
            expect(script.attr('src')).toMatch(/https:\/\/cdnapisec\.kaltura\.com\/p\/different\/sp\/different00\/embedIframeJs\/uiconf_id\/123-456-def\/partner_id\/different\?autoembed=true&entry_id=abc123&playerId=kaltura_player_\d{10}&cache_st=\d{10}&flashvars\[streamerType\]=auto/);
        });
        ...
        it('should watch the playerid and reload the video', function() {
            ...
            expect(angular.element.prototype.append.calls.count()).toBe(2);
            var script = angular.element.prototype.append.calls.mostRecent().args[0];
            expect(script.attr('src')).toMatch(/https:\/\/cdnapisec\.kaltura\.com\/p\/partner-1337\/sp\/partner-133700\/embedIframeJs\/uiconf_id\/different\/partner_id\/partner-1337\?autoembed=true&entry_id=abc123&playerId=kaltura_player_\d{10}&cache_st=\d{10}&flashvars\[streamerType\]=auto/);
        });
    });
});
