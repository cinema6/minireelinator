        ...
        describe('EditCardDisplayAdController', function() {
            ...
            beforeEach(function() {
                ...
                $rootScope.$apply(function() {
                    EditCardDisplayAdController = $controller('EditCardDisplayAdController');
                });
            });

            it('should exist', function() {
                expect(EditCardDisplayAdController).toEqual(jasmine.any(Object));
            });

            describe('properties', function() {
                describe('adChoices', function() {
                    it('should get an array of choices from the MiniReelService', function() {
                        expect(EditCardDisplayAdController.choices).toEqual(adChoices);
                    })
                });
            });
        });
