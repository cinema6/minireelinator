        ...
        describe('properties', function() {
            describe('filter', function() {
                it('should be the filter query param from the url, or default to all statuses', function() {
                    expect(campaigns.filter).toBe('draft,pending,approved,active,paused,canceled,expired,error');
        ...
        describe('model()', function() {
            ...
            it('should be for a list of campaigns', function() {
                expect(paginatedDbList).toHaveBeenCalledWith('selfieCampaign', {
                    sort: 'lastUpdated,-1',
                    application: 'selfie',
                    statuses: 'draft,pending,approved,active,paused,canceled,expired,error'
