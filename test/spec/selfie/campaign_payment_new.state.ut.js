define(['app'], function(appModule) {
    ...
    ['Selfie:New:Campaign:Payment:New','Selfie:Edit:Campaign:Payment:New'].forEach(function(stateName) {
        describe('Selfie:Campaign:Payment:New State', function() {
            var c6State,
                $rootScope,
                $q,
                PaymentState,
            ...
            beforeEach(function() {
                ...
                PaymentState = c6State.get(stateName);
            });
